...
//     const selectedSpot = spots.find((s) => s._id === spotId);
//     const isFavourite = userFavourite?.spotId?.includes(selectedSpot?._id);
//     const canToggleFavourite = userId && userFavourite?.userId;
...
//             Alert.alert('Bạn cần đăng nhập để thêm địa điểm yêu thích');
//             return;
//         }
    ...
    const handleToggleFavourite = () => {
        ...
        if (isFavourite) {
            ...
            dispatch(
                ...
                // hoặc dùng ToastAndroid nếu muốn nhanh hơn
                // ToastAndroid.show(`Đã thêm "${name}" vào yêu thích`, ToastAndroid.SHORT);
            });
        }
    };
